...
const SVG = styled.svg`
    ...
    height: 30px;
    margin-inline: 10px;
    fill: ${(props: any) => (props.fill ? props.fill : 'blue')};
`;
...
export const Logo = () => {
    return (
        <svg
            width="40"
            height="40"
            viewBox="0 0 52.049072 31.291473"
            version="1.1"
            id="svg5"
            xmlns="http://www.w3.org/2000/svg"
        >
                ...
                <g id="g664" transform="matrix(1.0574674,0,0,1,-19.624277,0)">
                    <g id="g654">
                        ...
                        <text
                            ...
                            id="text407"
                        >
                            <tspan id="tspan405" x="339.17142" y="432.70853">
                                M
                            </tspan>
                        </text>
                    </g>
                    <g
                        id="g647"
                        transform="matrix(1,0,0,0.94387938,-4.8857144,25.612527)"
                    >
                        <path
                            fill="rgb(0 12 76) 67%"
                            strokeWidth={1.60362}
                            d="m 376.97143,401.39998 c 3.07514,5.14472 6.14914,10.28753 6.16098,15.34359 0.0118,5.05607 -3.03785,10.02784 -6.08733,14.99927"
                            id="path536"
                        />
                        <path
                            fill="rgb(0 12 76) 67%"
                            strokeWidth={1.60362}
                            d="m 395.28455,431.74211 c -3.0103,-5.18293 -6.01948,-10.36393 -5.96783,-15.41975 0.0517,-5.05582 3.16353,-9.9889 6.27519,-14.92165"
                            id="path636"
                        />
                        <circle
                            fill="rgb(0 12 76) 67%"
...
export const CloseIcon = (props: { onClick: (e: any) => void }) => {
    return (
        <svg
            width="30"
            height="30"
...
export const MenuIcon = (props: { onClick: (e: any) => void }) => {
    return (
        <svg
            version="1.1"
            id="Capa_1"
...
export const OpensourceIcon = () => {
    return (
        <IconContext.Provider value={{ size: '34', color: '#ff6a00' }}>
